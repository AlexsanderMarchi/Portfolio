...
function About() {
  const items = document.querySelectorAll("#apresentation .column");
    ...
    <div id="about" className="flex-items">
      <div className="apresentation flex-items bg-secundary left img-left">
        <div className="column reverse">
          <img src={myself} alt="Myself" className="img-left" />
        </div>
        <div className="column">
          ...
          <p>
            Ja desenvolvi em JavaScript, React, React Native, C++, Node.js e
      ...
      <div className="apresentation flex-items bg-grey right img-right">
        <div className="column reverse">
          ...
          <p>
            Ja tendo concluído o curso Técnico em Desenvolvimento de Sistemas no
            Senai São José, estou cada dia lutando mais para conseguir me
            desenvolver profissionalmente e como pessoa.
          </p>
          <p>
        ...
        <div className="column">
          <img src={random} alt="Myself" className="img-right" />
        </div>
      </div>
